                    ...
                    <div class="bg-gray-100 p-6 rounded-lg shadow-md">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white">Diskon
                                    Merdeka</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Template</label>
                                <p class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white">Template
                                    1</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Kontak</label>
                                <p class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white">Kontak
                                    Grup Pak Joko</p>
                            </div>
                            <div>
                                <div class="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="time"
                                            class="mt-6 block w-full border-gray-300 rounded-md shadow-sm">
                                    </div>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white">
                                    <img src="src/about.jpg" alt="Pratinjau Gambar">
                                    <p>LOREM IPSUM</p>
                            ...
                            <div>
                                ...
                                <p class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white"><input
                                        type="checkbox" checked disabled> Ada</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Alamat URL</label>
                                <p class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white">
                                    www.wapi.com</p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Tombol</label>
                                <p class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white">CEK
                                    SEKARANG</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-100 p-6 rounded-lg shadow-md">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    class="flex items-center mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-white relative">
                                    <p>195</p>
                                    <div class="ml-auto"> <a href="#" class="text-blue-500"><svg
