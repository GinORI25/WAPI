...
<body class="flex bg-gray-100">
    ...
    <div class="flex flex-col flex-1 p-6">
        ...
        <div class="flex flex-col space-y-4">
            @livewire('broadcast-list')
            @livewireScripts

            <script>
                document.addEventListener('livewire:load', function () {
                    Livewire.on('broadcastToEdit', (broadcastData) => {
                        console.log('Broadcast data received for editing:', broadcastData.broadcast);
                        // Arahkan ke halaman edit menggunakan ID broadcast
                        window.location.href = '/path/to/edit/' + broadcastData.broadcast
