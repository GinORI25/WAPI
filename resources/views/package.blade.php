        ...
        <section class="mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded shadow relative">
                    <span class="absolute top-2 right-2 bg-green-500 text-white py-1 px-3 rounded-full text-xs">HOT
                        PROMO</span>
                    ...
                    <a href="{{ url('/buy') }}" class="block text-center bg-green-500 text-white py-2 rounded">Beli</a>
                </div>
                <!-- Card 2 -->
                <div class="bg-white p-6 rounded shadow relative">
                    <span class="absolute top-2 right-2 bg-green-500 text-white py-1 px-3 rounded-full text-xs">HOT
