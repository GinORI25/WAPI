    ...
    <div class="flex">
        <aside class="w-64 min-h-screen bg-green-900 text-white p-4">
            ...
            <nav class="flex flex-col space-y-4">
                ...
                <a href="/custompay" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="/customorder" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ url('/customexp') }}" class="py-2.5 px-6 bg-green-900 hover:bg-green-800 flex items-center">
                    <svg class="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <main class="flex-1 p-8">
            <div class="max-w-lg mx-auto bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-green-600 p-6">
                    <h2 class="text-center text-xl text-white font-semibold">Log Out</h2>
                </div>
                <div class="relative items-center p-6">
                    <h3 class="text-2xl font-bold text-gray-700 mb-4 text-center">Are You Sure Want To Logout?</h3>
                    <a>
                        <button class="bg-gray-300 text-gray-700 p-2 rounded">&lt;&lt; Dashboard</button>
                    </a>
                    <a>
                        <button class="bg-green-600 text-white p-2 rounded">Logout &gt;&gt;</button>
                    </a>
                </div>
            </div>
    </div>
