        ...
        <div class="flex flex-col md:flex-row gap-4 mt-6">
            <div class="min-w-full bg-white pt-5 p-7 rounded-lg shadow-lg">
                ...
                <div class="mx-auto bg-white p-6 rounded-lg mt-6 border-2 border-black relative">
                    <!-- ID User Field -->
                    <span
                        class="absolute top-0 right-0 bg-green-100 text-green-500 bold px-3 py-1 top-2 right-2 rounded-tr-lg rounded-full text-sm">EXPIRED</span>
